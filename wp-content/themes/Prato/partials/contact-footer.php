...
<section>
  <div  class="main-contact" style="background-image: url(<?php echo get_template_directory_uri();?>/assets/img/image.png);">
    ...
    <div class="form__item form__item--contact form-custom-f">
      <div>
        <div class="row">
          ...
          <form method="POST" action="https://nivel.activehosted.com/proc.php" id="_form_11_" class="_form _form_11 _inline-form  _dark" novalidate>
                ...
                <div class="_row _checkbox-radio">
                  ...
                  <span>
                    <label for="field_4Acepto2">
                      <span style="color: white; font-size: 14px;" >Acepto</span> <a target="_blank" href="<?php echo get_template_directory_uri();?>/assets/img/MANUAL_DE_POLITICAS_PROMOTORA.pdf"><span style="color: white; font-size: 14px; border-bottom: 1px solid;" >políticas y
                      privacidad</span></a>
                    </label>
                  </span>
                </div>
            ...
            <div class="_button-wrapper _full_width">
              <button id="_form_11_submit" class="_submit btn btn-black btn-form btn-form--w" type="submit">
                Enviar
              </button>
            </div>
        ...
        <div class="row form-group">
          <div class="col-md-12 ">
            <input type="submit" value="Enviar " class="btn btn-black btn-form btn-form--w" />
          </div>
        </div> -->
